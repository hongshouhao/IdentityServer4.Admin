    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            if (user == null)
            {
                ...
                throw new Exception("External authentication error. Not found the specific user.");
        ...
        private async Task<(UserIdentity user, string provider, string providerUserId, IEnumerable<Claim> claims)> FindUserFromExternalProvider(AuthenticateResult result)
        {
